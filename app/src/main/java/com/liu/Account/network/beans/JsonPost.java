...
import com.liu.Account.network.utils.MD5Utils;
import com.liu.Account.network.utils.ReflectUtil;
	...
	private String generateSign() {
		...
		if(request != null){
			...
			for (Field field : fields) {
				try {
					String name=ReflectUtil.getterNameFromField(field);
					if (name.endsWith("get$change"))continue;
